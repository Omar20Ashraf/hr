...
@section('content')
    ...
    <section id="login-register" class="p_b70 p_t70">
        ...
        <div class="tab-content">
            ...
            @include('sections.login',['routeName'=>route('studyCompanyLogin')])
                                ...
                                <div class="row">
                                  @include('admin/elements/flash')
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <form class="registerd" method="POST" action="{{ route('studyCompanyRegister') }}" enctype="multipart/form-data">
                                            {{ csrf_field() }}
                                            <div class="row">
                                                  <div class="col-md-8">
