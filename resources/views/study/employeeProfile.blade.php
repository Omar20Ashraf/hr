        ...
        <div class="container">
            ...
            <div class="col-md-3">
                ...
                <div class="background-green">
                    ...
                    <img src="{{url('public/storage/Images/studyEmployee/'.$employee->image)}}" class="img-responsive"/>
            ...
            <div class="col-md-9 col-sm-12 col-xs-12">
                ...
                <div class="background-white wow fadeInLeft">
                    ...
                    <div class="row">
                        ...
                        @php
                            $experiences = App\Models\workExperience::where('type',3)->where('user_id',$employee->id)->latest()->get();

                            $certificates = App\Models\Certificates::where('type',3)->where('user_id',$employee->id)->latest()->get();
                        @endphp
...
{{--                                             <a href="{{route('dowloadCertificate',['file_name'=>$certificate->certificate,'folderName'=>'studyCertificates'])}}">
                                            <i class="fa fa-download"></i>

                                                {{$certificate->name}}
                                            </a> --}}

                                            <a class="fancybox" rel="gallery1" href="{{url('public/storage/Images/studyCertificates/'.$certificate->certificate)}}">
                                            <i class="fa fa-download"></i>
                                                {{$certificate->name}}
                                            </a>
                                        </p>
                ...
                <div class="employee-edit">
                    <a href="{{ route('editStudyEmployee',$employee->slug) }}" class="employee-edit-button">
                        @lang('messages.Edit Your Information')
                    </a>
                    -
                    <a href="{{ route('showEmployeeExperience',['slug'=>$employee->slug,'userType' => '6']) }}" class="employee-edit-button">
                        @lang('messages.Edit Work Experience')
                    </a>
                    -
                    <a href="{{ route('showEmployeeCertificates',['slug'=>$employee->slug,'userType' => '6']) }}" class="employee-edit-button">
