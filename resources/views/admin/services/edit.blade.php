...
@section('content')
    ...
    <div class="panel panel-flat">
        ...
        <br>
            {!! Form::open(['route'=>['admin.service.update',$service->id],'method'=>'Post','class'=>'form-horizontal','style'=>'margin:20px','files'=>true]) !!}
            {{ Form::hidden('_method','Put') }}
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        {{ Form::text('title_ar',$service->title_ar,array('class'=>'form-control')) }}
                     </div>
                </div>
                 ...
                 <div class="form-group">
                     ...
                     <div class="col-md-6">
                         {{ Form::textarea('description',$service->description,array('class'=>'form-control ckeditor','id'=>'description','required'=>'required')) }}
                      </div>
                 </div>
                ...
                <div class="form-group">
                     ...
                     <div class="col-md-6">
                         {{ Form::textarea('description_ar',$service->description_ar,array('class'=>'form-control ckeditor','id'=>'description_ar','required'=>'required')) }}
                      </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        <img src="{{url('public/storage/Images/services/'.$service->image)}}" class="img-responsive" style="width:100px;height:100px;" />
                    </div>
                </div>
