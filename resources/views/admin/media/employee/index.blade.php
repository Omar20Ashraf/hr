...
@section('title')
    {{ config('app.name') }} | Media Employees
@endsection
...
@section('content')
    ...
    <div class="page-header page-header-default">
        <div class="page-header-content">
            <div class="page-title">
                <h4><i class="icon-arrow-right6 position-left"></i> <span class="text-semibold">Home</span> - Media Employees</h4>
            </div>
        </div>
    </div>
    <!-- /page header -->
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title col-sm-6 pull-left">Media Employees</h5>
            <a href="{{ route('admin.mediaEmployees.create') }}" class="btn bg-teal-400 btn-labeled btn-rounded pull-right" ><b><i class=" icon-plus-circle2"></i></b>New</a>
        </div>
            ...
            <tbody>
                @foreach ($employees as $employee)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.getExperience',['type'=>2,'user_id'=>$employee->id]) }}">
                        ...
                        <td>
                            <a href="{{ route('admin.getCertificate',['type'=>2,'user_id'=>$employee->id,'folderName'=>'mediaCertificates']) }}" >
                        ...
                        <td>
                            <img src="{{url('public/storage/Images/mediaEmployee/'.$employee->image)}}" class="img-responsive" style="width:100px;height:100px;border-radius:50%;" />
                        </td>
                        ...
                        {{-- //edit the job --}}
                            <a href="{{route('admin.mediaEmployees.edit',$employee->id) }}" >
                            ...
                            <a  onclick="return confirm('Are you sure?')"
                                ...
                                <form style="display: inline;" action="{{route('admin.mediaEmployees.destroy',$employee->id)}}"  method="POST">
                                    {{csrf_field()}}
                                    {{method_field('DELETE')}}
