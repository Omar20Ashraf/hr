...
@section('content')
    ...
    <div class="panel panel-flat">
        ...
        <br>
            ...
            {!! Form::open(['route'=>'admin.mediaEmployees.store','method'=>'Post','class'=>'form-horizontal','style'=>'margin:20px','files'=>true]) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        {{ Form::text('video',old('video'),array('class'=>'form-control','required'=>'required')) }}
                     </div>
                </div>
