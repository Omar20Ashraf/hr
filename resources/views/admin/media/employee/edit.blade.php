...
@section('title')
    {{ config('app.name') }} | Media Employee
@endsection
...
@section('content')
    ...
    <div class="page-header page-header-default">
        <div class="page-header-content">
            <div class="page-title">
                <h4><i class="icon-arrow-right6 position-left"></i> <span class="text-semibold">Home</span> - Media Employee</h4>
            </div>
        </div>
    ...
    <div class="panel panel-flat">
        ...
        <br>
            ...
            {!! Form::open(['route'=>['admin.mediaEmployees.update',$employee->id],'method'=>'Post','class'=>'form-horizontal','style'=>'margin:20px','files'=>true]) !!}

                {{ Form::hidden('_method','Put') }}


                {{ Form::hidden('id', $employee->id) }}
                {{ Form::hidden('ModelName', 'MediaEmployee') }}
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        {{ Form::text('phone',$employee->phone,array('class'=>'form-control','required'=>'required')) }}
                     </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    {{ Form::label('video','Video Link',['class' => 'control-label col-sm-3']) }}
                    <div class="col-md-4">
                        {{ Form::text('video',$employee->video,array('class'=>'form-control','required'=>'required')) }}
                     </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        <img src="{{url('public/storage/Images/mediaEmployee/'.$employee->image)}}" name="df_image" style="width:100px;height:100px;"/>
                    </div>
                </div>
