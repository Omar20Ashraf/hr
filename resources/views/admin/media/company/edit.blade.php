...
@section('content')
    ...
    <div class="panel panel-flat">
        ...
        <br>
            ...
            {!! Form::open(['route'=>['admin.mediaCompanines.update',$job->id],'method'=>'Post','class'=>'form-horizontal','style'=>'margin:20px','files'=>true]) !!}

                {{ Form::hidden('_method','Put') }}

                {{ Form::hidden('id', $job->id) }}
                {{ Form::hidden('ModelName', 'MediaCompany') }}
                    ...
                    <div class="col-md-9">
                        ...
                        @if($job->image)
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-3">
                                        <img src="{{url('public/storage/Images/mediaCompanies/'.$job->image)}}" name="df_image" style="width:100px;height:100px;"/>
                                    </div>
