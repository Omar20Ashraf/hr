...
@section('content')
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title col-sm-6 pull-left">Study Companies</h5>
            <a href="{{ route('admin.studyCompanines.create') }}" class="btn bg-teal-400 btn-labeled btn-rounded pull-right" ><b><i class=" icon-plus-circle2"></i></b>New</a>
        </div>
            ...
            <tbody>
                @foreach ($jobs as $job)
                    <tr>
                        ...
                        <td>
                            @if($job->image)
                                <img src="{{url('public/storage/Images/studyCompanies/'.$job->image)}}" class="img-responsive" style="width:100px;height:100px;border-radius:50%;" />
                            @else
                                No Image
                            @endif
                        </td>
                        ...
                        {{-- //edit the job --}}
                            <a href="{{route('admin.studyCompanines.edit',$job->id) }}" >
                            ...
                            <a  onclick="return confirm('Are you sure?')"
                                ...
                                <form style="display: inline;" action="{{route('admin.studyCompanines.destroy',$job->id)}}"  method="POST">
                                    {{csrf_field()}}
                                    {{method_field('DELETE')}}
