...
@section('title')
    {{ config('app.name') }} | Study Employee
@endsection
...
@section('content')
    ...
    <div class="page-header page-header-default">
        <div class="page-header-content">
            <div class="page-title">
                <h4><i class="icon-arrow-right6 position-left"></i> <span class="text-semibold">Home</span> - Study Employee</h4>
            </div>
        </div>
    ...
    <div class="panel panel-flat">
        ...
        <br>
            ...
            {!! Form::open(['route'=>['admin.studyEmployees.update',$employee->id],'method'=>'Post','class'=>'form-horizontal','style'=>'margin:20px','files'=>true]) !!}

                {{ Form::hidden('_method','Put') }}

                {{ Form::hidden('id', $employee->id) }}
                {{ Form::hidden('ModelName', 'StudyEmployee') }}
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        <img src="{{url('public/storage/Images/studyEmployee/'.$employee->image)}}" name="df_image" style="width:100px;height:100px;"/>
                    </div>
                </div>
