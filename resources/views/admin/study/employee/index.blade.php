...
@section('content')
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title col-sm-6 pull-left">Study Employees</h5>
            <a href="{{ route('admin.studyEmployees.create') }}" class="btn bg-teal-400 btn-labeled btn-rounded pull-right" ><b><i class=" icon-plus-circle2"></i></b>New</a>
        </div>
            ...
            <tbody>
                @foreach ($employees as $employee)
                    <tr>
                        ...
                        {{-- //edit the job --}}
                            <a href="{{route('admin.studyEmployees.edit',$employee->id) }}" >
