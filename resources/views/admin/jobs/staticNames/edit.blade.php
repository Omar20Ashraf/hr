...
@section('content')
    ...
    <div class="page-header page-header-default">
        <div class="page-header-content">
            <div class="page-title">
                <h4><i class="icon-arrow-right6 position-left"></i> <span class="text-semibold">Home</span> - Carier Names</h4>
            </div>
        </div>
    </div>
    <!-- /page header -->
    ...
    <div class="panel panel-flat">
        ...
        {!! Form::open(['route'=>['admin.updateCarierStaticNames',$name->id],'method'=>'Post','class'=>'form-horizontal','style'=>'margin:20px']) !!}
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        {{ Form::label('select_employee','Employee',['class' => 'control-label col-sm-3']) }}
                        <div class="col-md-9">
                    ...
                    <div class="form-group">
                        {{ Form::label('select_employee_slug','Employee Slug',['class' => 'control-label col-sm-3']) }}
                        <div class="col-md-9">
                    ...
                    <div class="form-group">
                        {{ Form::label('select_company','Company',['class' => 'control-label col-sm-3']) }}
                        <div class="col-md-9">
                    ...
                    <div class="form-group">
                        {{ Form::label('select_company_slug','Company Slug',['class' => 'control-label col-sm-3']) }}
                        <div class="col-md-9">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        {{ Form::label('select_employee_ar','Employee',['class' => 'control-label col-sm-3']) }}
                        <div class="col-md-9">
                    ...
                    <div class="form-group">
                        {{ Form::label('select_employee_slug_ar','Employee Slug',['class' => 'control-label col-sm-3']) }}
                        <div class="col-md-9">
                    ...
                    <div class="form-group">
                        {{ Form::label('select_company_ar','Company',['class' => 'control-label col-sm-3']) }}
                        <div class="col-md-9">
                    ...
                    <div class="form-group">
                        {{ Form::label('select_company_slug_ar','Company Slug',['class' => 'control-label col-sm-3']) }}
                        <div class="col-md-9">
