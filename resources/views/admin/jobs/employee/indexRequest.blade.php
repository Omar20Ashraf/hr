...
@section('title')
    {{ config('app.name') }} | Carier Employees Requests
@endsection
...
@section('content')
    ...
    <div class="page-header page-header-default">
        <div class="page-header-content">
            <div class="page-title">
                <h4><i class="icon-arrow-right6 position-left"></i> <span class="text-semibold">Home</span> - Carier Employees Requests</h4>
            </div>
        </div>
    </div>
    <!-- /page header -->
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title col-sm-6 pull-left">Carier Employees Requests</h5>
        </div>
                ...
                @foreach ($employees as $employee)
                    <tr>
                        ...
                        <td>
                            ...
                            @else
                                    <a onclick="return confirm('Are you sure?')" href="{{route('admin.approveCarierEmployee',$employee->id)}}">
