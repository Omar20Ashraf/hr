...
@section('content')
    ...
    <div class="page-header page-header-default">
        <div class="page-header-content">
            <div class="page-title">
                <h4><i class="icon-arrow-right6 position-left"></i> <span class="text-semibold">{{ trans('messages.Home') }}</span> - Carier Employees</h4>
            </div>
        </div>
    ...
    <div class="panel panel-flat">
        ...
        <br>
            ...
            {!! Form::open(['route'=>'admin.carierEmployees.store','method'=>'Post','class'=>'form-horizontal','style'=>'margin:20px','files'=>true]) !!}
