...
@section('title')
    {{ config('app.name') }} | Carier Companies
@endsection
...
@section('content')
    ...
    <div class="page-header page-header-default">
        <div class="page-header-content">
            <div class="page-title">
                <h4><i class="icon-arrow-right6 position-left"></i> <span class="text-semibold">Home</span> - Carier Companies</h4>
            </div>
        </div>
    </div>
    <!-- /page header -->
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title col-sm-6 pull-left">Carier Companies</h5>
            <a href="{{ route('admin.jobCompanies.create') }}" class="btn bg-teal-400 btn-labeled btn-rounded pull-right" ><b><i class=" icon-plus-circle2"></i></b>{{ trans('messages.New') }}</a>
        </div>
            ...
            <tbody>
                @foreach ($jobs as $job)
                    <tr>
                        ...
                        <td>
                            @if($job->image)
                                <img src="{{url('public/storage/Images/carierCompanies/'.$job->image)}}" class="img-responsive" style="width:100px;height:100px;border-radius:50%;" />
                            @else
                                No Image
                            @endif
                        </td>
                        ...
                        {{-- //edit the job --}}
                            <a href="{{route('admin.jobCompanies.edit',$job->id) }}" >
                            ...
                            <a  onclick="return confirm('Are you sure?')"
                                ...
                                <form style="display: inline;" action="{{route('admin.jobCompanies.destroy',$job->id)}}"  method="POST">
                                    {{csrf_field()}}
                                    {{method_field('DELETE')}}
