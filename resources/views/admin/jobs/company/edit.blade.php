...
@section('content')
    ...
    <div class="page-header page-header-default">
        <div class="page-header-content">
            <div class="page-title">
                <h4><i class="icon-arrow-right6 position-left"></i> <span class="text-semibold">{{ trans('messages.Home') }}</span> - Carier Companies</h4>
            </div>
        </div>
    ...
    <div class="panel panel-flat">
        ...
        <br>
            ...
            {!! Form::open(['route'=>['admin.jobCompanies.update',$job->id],'method'=>'Post','class'=>'form-horizontal','style'=>'margin:20px','files'=>true]) !!}

                {{ Form::hidden('_method','Put') }}

                {{ Form::hidden('id', $job->id) }}
                {{ Form::hidden('ModelName', 'JobCompany') }}{{-- to use in the request --}}
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        {{ Form::number('phone',$job->phone,array('class'=>'form-control','required'=>'required')) }}
                     </div>
                </div>
                    ...
                    <div class="col-md-9">
                        ...
                        @if($job->image)
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-3">
                                        <img src="{{url('public/storage/Images/carierCompanies/'.$job->image)}}" name="df_image" style="width:100px;height:100px;"/>
                                    </div>
                                </div>
                            </div>
                        @endif
