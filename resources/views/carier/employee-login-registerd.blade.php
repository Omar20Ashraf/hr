...
@section('title')
{{config('app.name')}} | ICarier Employee
@endsection
    ...
    <section id="login-register" class="p_b70 p_t70">
        @if(auth()->guest())
            ...
            <div class="tab-content">
                ...
                @include('sections.login',['routeName'=>route('carierEmployeeLogin')])
                                ...
                                <div class="login-register-bg">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <form class="registerd" method="POST" action="{{ route('carierEmployeeRegister') }}" enctype="multipart/form-data">
                                                {{ csrf_field() }}
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="listing-title-area">
                                                            ...
                                                            <div class="form-group">
                                                                <label>
                                                                    {{(Config::get('app.locale') == 'ar') ? $globalNames->birth_date_ar :$globalNames->birth_date }}
                                                                    <span>*</span>
                                                                </label>
                                                ...
                                                <option value="{{$service->id}}" {{(old('military_service') == $service->id) ? 'selected' : ''}}>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="listing-title-area">
                                                            ...
                                                            <div class="form-group">
                                                                <label>
                                                                    {{(Config::get('app.locale') == 'ar') ? $names->talk_about_ar :$names->talk_about }}
                                                                    <span>*</span>
                                                                </label>
                                                                <div class="cleaner-h1"></div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="listing-title-area">
                                                            ...
                                                            <div class="form-group">
                                                                <label>
                                                                    {{(Config::get('app.locale') == 'ar') ? $globalNames->email_ar :$globalNames->email }}
                                                                    <span>*</span>
                                                                </label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="listing-title-area">
                                                            ...
                                                            <div class="form-group">
                                                                <label>
                                                                    {{(Config::get('app.locale') == 'ar') ? $globalNames->re_password_ar :$globalNames->re_password }}
                                                                    <span>*</span>
                                                                </label>
