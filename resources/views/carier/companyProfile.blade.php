            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="background-white wow fadeInLeft">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                               ...
                               <h4 class="h4-style"><span>{{(Config::get('app.locale') == 'ar') ? $globalNames->job_ar :$globalNames->job }} :</span>
                                    <p>
                                        {{$company->job_title}}
                                    </p>
                                </h4>
                                <h4 class="h4-style"><span>
                                    {{(Config::get('app.locale') == 'ar') ? $names->company_name_ar :$names->company_name }} :</span>
                                    <p>
                                        {{$company->name}}
                                    </p>
                                </h4>
                            ...
                            <div class="col-md-4">
                                @if($company->image)
                                    <img src="{{url('public/storage/Images/carierCompanies/'.$company->image)}}" class="img-responsive width-img"/>
                                @endif
                           </div><!--end col-4-->
                    ...
                    <div class="background-white wow fadeInLeft">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                               ...
                               <h4 class="h4-style"><span>{{(Config::get('app.locale') == 'ar') ? $names->job_description_ar :$names->job_description }} :</span>
                                    <br>
                    ...
                    <div class="company-edit">
                        <a href="{{ route('editCarierCompany',$company->slug) }}" class="company-edit-button">
