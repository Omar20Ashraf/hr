            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <div class="background-blue">
                        ...
                        <img src="{{url('public/storage/Images/carierEmployee/'.$employee->image)}}" class="img-responsive"/>

                        <div class="contact">
                            <h4>
                                {{(Config::get('app.locale') == 'ar') ? $globalNames->contact_ar :$globalNames->contact }}
                            </h4>
                            <div class="line"></div>
                                <ul>
                ...
                <div class="background-white wow fadeInLeft">
                    ...
                    <div class="row">
                        ...
                        @php
                            $experiences = App\Models\workExperience::where('type',1)->where('user_id',$employee->id)->latest()->get();

                            $certificates = App\Models\Certificates::where('type',1)->where('user_id',$employee->id)->latest()->get();
                        @endphp
                            ...
                            <div class="col-md-12">
                                ...
                                @if(sizeof($experiences) > 0)
                                    ...
                                    @else
                                        ...
                                        <span>{{$experience->name}}</span>
                                    @endif                                        <div class="cleaner-h1"></div>
                                    @endforeach
                                @endif
...
{{--                                             <a class="fancybox" rel="gallery1"  href="{{route('dowloadCertificate',['file_name'=>$certificate->certificate,'folderName'=>'carierCertificates'])}}">
                                            <i class="fa fa-download"></i>

                                                {{$certificate->name}}
                                            </a> --}}

                                            <a class="fancybox" rel="gallery1" href="{{url('public/storage/Images/carierCertificates/'.$certificate->certificate)}}">
                                            <i class="fa fa-download"></i>
                                                {{$certificate->name}}
                                            </a>
                                        </p>
                ...
                <div class="employee-edit">
                    <a href="{{ route('editCarierEmployee',$employee->slug) }}" class="employee-edit-button">
                        @lang('messages.Edit Your Information')
                    </a>
                    -
                    <a href="{{ route('showEmployeeExperience',['slug'=>$employee->slug,'userType' => '2']) }}" class="employee-edit-button">
                        @lang('messages.Edit Work Experience')
                    </a>
                    -
                    <a href="{{ route('showEmployeeCertificates',['slug'=>$employee->slug,'userType' => '2']) }}" class="employee-edit-button">
                        @lang('messages.Edit Ceritificates')
                    </a>
                </div>
