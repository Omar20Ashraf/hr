            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="background-white wow fadeInLeft">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            @if($company->image)
                                <img src="{{url('public/storage/Images/mediaCompanies/'.$company->image)}}" class="img-responsive width-img"/>
                            @endif
                        </div><!--end col-4-->
                ...
                <div class="company-edit">
                    <a href="{{ route('editMediaCompany',$company->slug) }}" class="company-edit-button">
