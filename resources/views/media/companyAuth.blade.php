...
@section('content')
    ...
    <section id="login-register" class="p_b70 p_t70">
        ...
        <div class="tab-content">
            ...
            @include('sections.login',['routeName'=>route('mediaCompanyLogin')])
                                ...
                                <div class="row">
                                  @include('admin/elements/flash')
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <form class="registerd" method="POST" action="{{ route('mediaCompanyRegister') }}" enctype="multipart/form-data">
                                            {{ csrf_field() }}
                                            <div class="row">
                                                  <div class="col-md-8">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="listing-title-area">
                                                        ...
                                                        <div class="form-group">
                                                            <label>
                                                              {{(Config::get('app.locale') == 'ar') ? $names->job_title_ar :$names->job_title }}<span>*</span>
                                                            </label>
                                                ...
                                                <div class="cleaner-h1"></div>
                                                  ...
                                                  <div class="col-md-12">
                                                      <div class="listing-title-area">
                                                        ...
                                                        <div class="form-group">
                                                            <label>
                                                              {{(Config::get('app.locale') == 'ar') ? $names->job_description_ar :$names->job_description }}<span>*</span>
                                                            </label>
                                                            <div class="cleaner-h1"></div>
