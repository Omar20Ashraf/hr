...
{{--                                             <a href="{{route('dowloadCertificate',['file_name'=>$certificate->certificate,'folderName'=>'mediaCertificates'])}}">
                ...
                <div class="employee-edit">
                    <a href="{{ route('editMediaEmployee',$employee->slug) }}" class="employee-edit-button">
                        @lang('messages.Edit Your Information')
                    </a>
                    -
                    <a href="{{ route('showEmployeeExperience',['slug'=>$employee->slug,'userType' => '4']) }}" class="employee-edit-button">
                        @lang('messages.Edit Work Experience')
                    </a>
                    -
                    <a href="{{ route('showEmployeeCertificates',['slug'=>$employee->slug,'userType' => '4']) }}" class="employee-edit-button">
