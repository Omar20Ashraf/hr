    ...
    <section id="login-register" class="p_b70 p_t70">
        ...
        @if(auth()->guest())
            ...
            <div class="tab-content">
                ...
                @include('sections.login',['routeName'=>route('mediaEmployeeLogin')])
                                ...
                                <div class="login-register-bg">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <form class="registerd" method="POST" action="{{ route('mediaEmployeeRegister') }}" enctype="multipart/form-data">
                                                {{ csrf_field() }}
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="listing-title-area">
                                                            ...
                                                            <div class="form-group">
                                                                <label>
                                                                    {{(Config::get('app.locale') == 'ar') ? $globalNames->name_ar :$globalNames->name }}<span>*</span>
                                                                </label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="listing-title-area">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="address" class="form-control" placeholder="{{(Config::get('app.locale') == 'ar') ? $globalNames->address_ar :$globalNames->address }}" value="{{old('address')}}">
                                                            </div>
                                                        </div><!--رقم الهاتف-->
                                                    </div><!--end col-12-->
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="listing-title-area">
                                                            ...
                                                            <div class="form-group">
                                                                <label>{{(Config::get('app.locale') == 'ar') ? $globalNames->birth_date_ar :$globalNames->birth_date }}<span>*</span>
                                                                </label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="listing-title-area">
                                                            ...
                                                            <div class="form-group">
                                                                <label>{{(Config::get('app.locale') == 'ar') ? $names->job_title_ar :$names->job_title }}
                                                                    <span>*</span>
                                                                </label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="listing-title-area">
                                                            ...
                                                            <div class="form-group">
                                                                <label>{{(Config::get('app.locale') == 'ar') ? $names->certificates_ar :$names->certificates }}
                                                                </label>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="listing-title-area">
                                                            ...
                                                            <div class="form-group">
                                                                <label>{{(Config::get('app.locale') == 'ar') ? $names->talk_about_ar :$names->talk_about }}
                                                                    <span>*</span>
                                                                </label>
                                                                <div class="cleaner-h1"></div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="listing-title-area">
                                                            ...
                                                            <div class="form-group">
                                                               ...
                                                               <input type="text"  name="video" class="form-control" placeholder="{{(Config::get('app.locale') == 'ar') ? $globalNames->video_ar :$globalNames->video }}" value="{{old('video')}}" />
                                                            </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="listing-title-area">
                                                            ...
                                                            <div class="form-group">
                                                                <label>{{(Config::get('app.locale') == 'ar') ? $globalNames->email_ar :$globalNames->email }}<span>*</span>
                                                                </label>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="listing-title-area">
                                                            ...
                                                            <div class="form-group">
                                                                <label>{{(Config::get('app.locale') == 'ar') ? $globalNames->password_ar :$globalNames->password }}<span>*</span>
                                                                </label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="listing-title-area">
                                                            ...
                                                            <div class="form-group">
                                                                <label>{{(Config::get('app.locale') == 'ar') ? $globalNames->re_password_ar :$globalNames->re_password }}<span>*</span>
                                                                </label>
