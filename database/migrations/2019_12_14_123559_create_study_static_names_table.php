...
class CreateStudyStaticNamesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('study_static_names', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->string('select_employee_ar');
            $table->string('select_employee_slug');
            $table->string('select_employee_slug_ar');
            $table->string('select_company');
            $table->string('select_company_ar');
            $table->string('select_company_slug');
            $table->string('select_company_slug_ar');
    ...
    {
        Schema::dropIfExists('study_static_names');
    }
}
